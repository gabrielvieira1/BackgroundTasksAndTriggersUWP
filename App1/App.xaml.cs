...
namespace App1
{
  ...
  sealed partial class App : Application
  {
    ...
    // Background Task no proprio App
    ...
    private async void RegisterBackgroundTask()
    {
      ...
      if (TaskReg == null)
      {
        ...
        Builder.TaskEntryPoint = "RuntimeComponent1.TaskRunner"; // Para rodar Background Task no proprio App precisa comentar essa linha
